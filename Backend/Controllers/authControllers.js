...
export const signUpController = async (req, res) => {
    try {
        ...
        const { name, role, email, password, confirmPassword, dob, age, gender, address } = req.body
        if (!name || !gender || !age || !email || !password || !confirmPassword || !address || !dob) {
            ...
            const user = await User.insertOne({ name, role, gender, age, dob, email, password: hasspassword, address, image: imageUrl })
